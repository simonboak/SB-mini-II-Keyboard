...
```
      ...
      UART RX  -->  GP1  | 2           39| VSYS
            ...
            D0  <--  GP2  | 4           37| 3V3_EN
            D1  <--  GP3  | 5           36| 3V3
            D2  <--  GP4  | 6           35| ADC_VREF
            D3  <--  GP5  | 7           34| GP28
                     GND  | 8           33| GND
            D4  <--  GP6  | 9           32| GP27
            D5  <--  GP7  |10           31| GP26
            D6  <--  GP8  |11           30| RUN
        STROBE  <--  GP9  |12           29| GP22
                     GND  |13           28| GND
         RESET  <-- GP10  |14           27| GP21
         SHIFT  <-- GP11  |15           26| GP20
                     GP12 |16           25| GP19
                     GP13 |17           24| GP18
                     GND  |18           23| GND
                     GP14 |19           22| GP17
...
|----------|--------------------------|----------------------------|
| GP0      | UART TX (debug, 115200)  | -                          |
| GP1      | UART RX                  | -                          |
| GP2-GP8  | Data D0-D6 (7-bit ASCII) | Active high                |
| GP9      | STROBE                   | Active high, ~100us pulse  |
| GP10     | RESET                    | Active high                |
| GP11     | SHIFT                    | Active high when held      |
...
UART stdio is enabled on GP0/GP1 for debug output at 115200 baud (8N1). Data pins start at GP2 to avoid conflict with the UART.
